...
def make_title(set_name):
    ...
    return ( r"Density+ GroupMeanMass |"
        + f" {set_name} | "
...
def load_feature_file(hfile, feature_type="group_Mean"):
...
class HaloDataset(Dataset):
    ...
    def __init__(self, density_grid, pos, vel, mass, feature,
        ...
        if self.feature_type == "group_Mean":
...
def evaluate_model(model, te_loader, test_ds,
    ...
    plt.tight_layout()
    plt.savefig("same_real_cnn_density_GroupMean.png")
    plt.show()
